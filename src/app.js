...
if (myDom.newListForm) {
  myDom.newListForm.addEventListener('submit', (e) => {
    ...
    myDom.newListInput.value = '';
    lists.push(list);
    saveAndRender();
  });
}

if (myDom.newTaskForm) {
  myDom.newTaskForm.addEventListener('submit', (e) => {
    ...
    const prioName = myDom.newPrioInput.options[myDom.newPrioInput.selectedIndex].text;
    if (
      titleName == null
      || titleName === ''
      || descName == null
    ...
    myDom.newListTitle.value = '';
    myDom.newListDesc.value = '';
    myDom.newListDate.value = '';
    myDom.newPrioInput.options[myDom.newPrioInput.selectedIndex].value = '';
    const selectedList = lists.find((list) => list.id === selectedListId);
  ...
  myDom.editTask.addEventListener('click', () => {
    ...
    myDom.newPrioInput.options[myDom.newPrioInput.selectedIndex].text = editPriority;
...
export { render, renderList, renderTaskCount };
